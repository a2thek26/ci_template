...
function css_asset($asset_name, $module_name = NULL, $attributes = array())
{
	...
	return '<link rel="stylesheet" type="text/css"'.$attribute_str.' href="'.css_asset_url($asset_name, $module_name).'" />' . PHP_EOL;
}
...
function image_asset($asset_name, $module_name = '', $attributes = array())
{
	...
	return '<img src="'.image_asset_url($asset_name, $module_name).'"'.$attribute_str.' />' . PHP_EOL;
}
...
{
	return '<script type="text/javascript" src="'.js_asset_url($asset_name, $module_name).'"></script>' . PHP_EOL;
}

function js_asset_full_url($url)
{
